...
def data_test_all_course() -> Tree[Course]:
    ...
    p1.appendChildNodes(
        Node[Course](Course('1', 'Test Course 1', '2', '1', result='', course_enrollment_times='')),
        Node[Course](Course('2', 'Test Course 2', '3', '1', result='', course_enrollment_times='')),
        Node[Course](Course('3', 'Test Course 3', '2', '1', result='Poor (2)', course_enrollment_times='1')),
        Node[Course](Course('4', 'Test Course 4', '2', '2', result='', course_enrollment_times='')),
        Node[Course](Course('5', 'Test Course 5', '5', '2', result='Average (3)', course_enrollment_times='1')),
    ...
    p2.appendChildNodes(
        ...
        Node[Course](Course('12', 'Test Course 12', '2', '4', result='', course_enrollment_times='')),
        Node[Course](Course('13', 'Test Course 13', '2', '4', result='', course_enrollment_times='')),
...
def data_test_enrolled_courses() -> list[EnrolledCourse]:
    return [
        ...
        EnrolledCourse('13', 'Test Course 13', '2', '1'),
